...
class People_doc_form extends Component {
    constructor(props){
        super(props);
        this.state={
            files:[],
  ...
  async handleSubmit(event){
    ...
    body = {
        ...
        docs_urls_1:picsurl,
        doc_name_1:this.state.doc_name,
        job:this.props.job
    };
    ...
    body = {
        user: cookies.get("addedparam"),
        docs_urls_2:picsurl,
        doc_name_2:this.state.doc_name,
        job:this.state.job
    };
    ...
    body = {
        user: cookies.get("addedparam"),
        docs_urls_3:picsurl,
        doc_name_3:this.state.doc_name,
        job:this.state.job
    };
    ...
    body = {
        user: cookies.get("addedparam"),
        docs_urls_4:picsurl,
        doc_name_4:this.state.doc_name,
        job:this.state.job
    };
    else
    body = {
        user: cookies.get("addedparam"),
        docs_urls_5:picsurl,
        doc_name_5:this.state.doc_name,
        job:this.state.job
    };
    ...
    render(){
        if(this.state.loader===true)
        {
            ...
            return (
                ...
                <h5><br/>{this.state.no} &nbsp; Upload Documents</h5><br/>
...
export default People_doc_form
