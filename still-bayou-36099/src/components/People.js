...
class People extends Component {
    ...
    componentDidMount() {
      ...
      if (this.props.match.params.industry === "Microfinance")
        path2 =
          "https://www.resolabindia.com/api/core/list_providers_people_all_mf/";
      else
        path2 =
          "https://www.resolabindia.com/api/core/list_providers_people_all/";
                                ...
                                case "All":
                                    return (
                                        <Container>
                                            ...
                                            }</CardDeck><b><a href={"/available/" + this.props.match.params.industry}>Explore More </a></b>
                                        </Container>
                                    );
                                default:
                                    return null;
