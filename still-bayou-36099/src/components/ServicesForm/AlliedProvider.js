...
class AllProviderForm extends Component {
   ...
   console.log(this.state.files.name);
    ...
    async handleSubmit(event){
      ...
      else if(this.state.service==="Others in Allied Services"&&this.state.other_in_service==="")
      {
      ...
      else if(this.state.presence.length===0){
        event.preventDefault();
        event.stopPropagation();
        this.setState({
        ...
        alert("Please select at least one state under geo presence");
          ...
          console.log("less than two images")
              event.preventDefault();
              event.stopPropagation();
              this.setState({
                  alert: true
        ...
        console.log(this.state.files);
              ...
              console.log(geo_presence)
                const body = {
                    ...
                    job:this.state.service==="Others in Allied Services"?this.state.other_in_service:this.state.service,
                ...
                <h4>Enter your details.</h4>
                    ...
                    <br />
                       ...
                       <br />
                        ...
                        <br />
                        <Form.Row>
                            <Form.Label className="" column="lg" lg={4}>
                                PAN Details:
                            </Form.Label>
                            <Col>
                                <Form.Control
                        ...
                        {
/*
                          this.state.service==="Others in Allied Services"?
                          <>
