...
function SeekerSkillingPagination() {
    ...
    useEffect(() => {
        const getCards = async () => {
            const res = await fetch(`https://www.resolabindia.com/api/core/list_seekers_people_all/?page=1&cards=${cardsTotal}`)
    ...
    const fetchCards = async (currentPage) => {
        const res = await fetch(`https://www.resolabindia.com/api/core/list_seekers_people_all/?page=${currentPage}&cards=${cardsTotal}`)
...
export default SeekerSkillingPagination